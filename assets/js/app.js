...
const Services = () => {
    const services = [
        ...
        },
        {
            ...
            description: 'הקמת חנות דיגיטלית למכירת מוצרים או שירותים עם סליקה מאובטחת וניהול מלאי',
            features: ['קטלוג מוצרים', 'סל קניות ותשלומים', 'ניהול מלאי', 'מערכת קופונים', 'התראות והודעות'],
            exampleLink: '',
            exampleName: ''
        },
        {
            icon: 'bx-calendar-check',
            title: '📅 מערכת הזמנות ותיאום פגישות',
            description: 'מערכת חכמה להזמנת תורים, פגישות או שירותים אונליין',
            features: ['יומן דינמי', 'התראות SMS/מייל', 'ניהול לקוחות', 'סנכרון עם גוגל/אאוטלוק', 'טפסים מותאמים'],
            exampleLink: '',
            exampleName: ''
        },
        {
            icon: 'bx-group',
            title: '👥 פורטל לקוחות/ספקים',
            description: 'אזור אישי מאובטח ללקוחות או ספקים עם מידע, מסמכים, תשלומים ותמיכה',
            features: ['התחברות מאובטחת', 'העלאת מסמכים', 'היסטוריית תשלומים', 'פניות ותמיכה', 'עדכונים בזמן אמת'],
            exampleLink: '',
            exampleName: ''
        },
        {
            icon: 'bx-news',
            title: '📰 בלוג מקצועי / מגזין תוכן',
            description: 'פלטפורמה לפרסום מאמרים, חדשות ועדכונים עם מערכת ניהול תוכן מתקדמת',
            features: ['מערכת תגובות', 'קטגוריות ותגים', 'SEO מתקדם', 'שיתוף לרשתות חברתיות', 'ניהול כותבים'],
            exampleLink: '',
            exampleName: ''
        },
        {
            icon: 'bx-bar-chart-alt',
            title: '📈 מערכת CRM לעסקים קטנים',
            description: 'ניהול לקוחות, לידים ומעקב מכירות במערכת אחת פשוטה',
            features: ['ניהול לידים', 'מעקב משימות', 'סטטיסטיקות ודוחות', 'אינטגרציה עם מייל', 'היסטוריית לקוח'],
            exampleLink: '',
            exampleName: ''
        },
        {
