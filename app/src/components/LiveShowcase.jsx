      ...
      <div className="mt-5 flex items-center justify-center gap-2">
        {systems.map((s, i) => (
          <button
            ...
            className={`flex items-center gap-2 rounded-full px-4 py-2 text-[13px] font-medium transition-all duration-400 ${
              i === active ? 'glass-strong text-white shadow-lg' : 'text-white/40 hover:text-white/70'
            }`}
          >
